...
<?php echo custom_validation_errors(); ?>
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="new-item">
				<a class="btn btn-default btn-sm button-adjust" href="<?php echo base_url('news/single_news/'.$y->id.'/'.$y->slug); ?>"><i class="fa fa-eye"></i> View News</a>
			...
			<?php echo form_open_multipart('news/edit_news_action/' . $y->id); ?>
